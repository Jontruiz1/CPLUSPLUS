...
//
// Parallel Cache-friendly Matrix Multiplication app
//
...
int main(int argc, char *argv[])
{
	...
	//
	_matrixSize = 1600;
	_numThreads = thread::hardware_concurrency();  // number of cores:

	ProcessCmdLineArgs(argc, argv);

	cout << "** Parallel Cache-friendly Matrix Multiply Application **" << endl << endl;
