// KLR_Functors:EX08_Functor  EX08_Functor.cpp
...
int main() {
    ...
    set<double> aSet{ 5.5, 1.1, 3.3, 4.4, 2.2 };
    ...
    set<double, std::greater<>> dSet{ 5.5, 1.1, 3.3, 4.4, 2.2 };
...
demonstrate_functors(InputIterator first, InputIterator last) {
    ...
    transform(first, last,
        ...
        aVect.begin(),
        bind(divides<double>(), placeholders::_1, 3.0));
