...
int main() {
    ...
    transform(v.begin(), v.end(), v.begin(), bind(multiplies<int>(), std::placeholders::_1, 3));
    ...
    transform(v.begin(), v.end(), v.begin(), bind(divides<int>(), std::placeholders::_1, 3));
    ...
    transform(v.begin(), v.end(), v2.begin(), bind(modulus<int>(), std::placeholders::_1, 10));
